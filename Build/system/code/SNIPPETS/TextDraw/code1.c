...
void Message_DrawText(PlayState* play, Gfx** gfxP) 
{
    ...
    HoL_DrawMessageTextImpl(play, NULL, gfxP, msgCtx->textBoxType == TEXTBOX_TYPE_NONE_NO_SHADOW ? COLOR_BLACK : COLOR_WHITE, COLOR_BLACK,
                            msgCtx->textColorAlpha, msgCtx->textColorAlpha, msgCtx->msgBufDecoded,
                            R_TEXT_INIT_XPOS, R_TEXT_INIT_YPOS, 1, 1,
